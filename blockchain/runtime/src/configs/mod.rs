//! Pallet configuration for the MediChain runtime.
...
parameter_types! {
    ...
    /// 2 seconds of compute with a 6 second average block time.
...
/// prelude meant for mock runtimes in unit tests, not for a real chain.)
