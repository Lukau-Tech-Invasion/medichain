...
pub async fn create_burn(
    ...
    let entity = BurnAssessmentEntity {
        ...
        assessment_datetime: body
            ...
            .unwrap_or(now),
        mechanism_of_injury: body
            .get("mechanism_of_injury")
            .and_then(|v| v.as_str())
            .unwrap_or_default()
            .to_string(),
        burn_agent: body
        ...
        affected_areas: body
            ...
            .cloned()
            .unwrap_or_else(|| serde_json::json!({})),
        inhalation_injury: body
            .get("inhalation_injury")
            .and_then(|v| v.as_bool())
            .unwrap_or(false),
        inhalation_symptoms: body
            .get("inhalation_symptoms")
            .and_then(|v| v.as_str())
            .map(str::to_string),
        airway_status: body
            .get("airway_status")
            .and_then(|v| v.as_str())
            .map(str::to_string),
        circumferential_burns: body
            .get("circumferential_burns")
            .and_then(|v| v.as_bool())
            .unwrap_or(false),
        circumferential_locations: body.get("circumferential_locations").cloned(),
        escharotomy_needed: body
            .get("escharotomy_needed")
            .and_then(|v| v.as_bool())
            .unwrap_or(false),
        escharotomy_performed: body
            .get("escharotomy_performed")
            .and_then(|v| v.as_bool())
            .unwrap_or(false),
        fluid_resuscitation_started: body
            .get("fluid_resuscitation_started")
            .and_then(|v| v.as_bool())
            .unwrap_or(false),
        parkland_formula_volume: body
            .get("parkland_formula_volume")
            .and_then(|v| v.as_i64())
            .map(|v| v as i32),
        urine_output_goal: body
            .get("urine_output_goal")
            .and_then(|v| v.as_i64())
            .map(|v| v as i32),
        pain_score: body
            .get("pain_score")
        ...
        tetanus_status: body
            ...
            .and_then(|v| v.as_str())
            .map(str::to_string),
        transfer_to_burn_center: body
            .get("transfer_to_burn_center")
            .and_then(|v| v.as_bool())
            .unwrap_or(false),
        burn_center_notified: body
            .get("burn_center_notified")
            .and_then(|v| v.as_bool())
            .unwrap_or(false),
        photos_taken: body
            .get("photos_taken")
...
pub async fn create_mci(
    ...
    let entity = MciRecordEntity {
        ...
        incident_name: body
            ...
            .unwrap_or_default()
            .to_string(),
        incident_datetime: body
            .get("incident_datetime")
            .and_then(|v| v.as_str())
            .and_then(|s| chrono::DateTime::parse_from_rfc3339(s).ok())
            .map(|d| d.with_timezone(&chrono::Utc))
            .unwrap_or(now),
        incident_location: body
        ...
        incident_type: body
            ...
            .and_then(|v| v.as_str())
            .filter(|s| !s.is_empty())
            .unwrap_or("natural_disaster")
            .to_string(),
        activation_level: body
            .get("activation_level")
            .and_then(|v| v.as_str())
            .filter(|s| !s.is_empty())
            .unwrap_or("level_1")
            .to_string(),
        incident_commander: body
            .get("incident_commander")
            .and_then(|v| v.as_str())
            .map(str::to_string),
        medical_branch_director: body
            .get("medical_branch_director")
            .and_then(|v| v.as_str())
            .map(str::to_string),
        hospital_incident_command_activated: body
            .get("hospital_incident_command_activated")
            .and_then(|v| v.as_bool())
            .unwrap_or(false),
        patient_id: body
            .get("patient_id")
            .and_then(|v| v.as_str())
            .map(str::to_string),
        triage_tag_number: body
            .get("triage_tag_number")
            .and_then(|v| v.as_str())
            .map(str::to_string),
        triage_category: body
            .get("triage_category")
            .and_then(|v| v.as_str())
            .filter(|s| !s.is_empty())
            .unwrap_or("red")
            .to_string(),
        start_triage_category: body
            .get("start_triage_category")
            .and_then(|v| v.as_str())
            .map(str::to_string),
        arrival_datetime: body
        ...
        mechanism_of_injury: body
            ...
            .and_then(|v| v.as_str())
            .map(str::to_string),
        decontamination_required: body
            .get("decontamination_required")
            .and_then(|v| v.as_bool())
            .unwrap_or(false),
        decontamination_completed: body
            .get("decontamination_completed")
            .and_then(|v| v.as_bool())
            .unwrap_or(false),
        ...
        disposition: body
            ...
            .and_then(|v| v.as_str())
            .map(str::to_string),
        disposition_datetime: body
            .get("disposition_datetime")
            .and_then(|v| v.as_str())
            .and_then(|s| chrono::DateTime::parse_from_rfc3339(s).ok())
            .map(|d| d.with_timezone(&chrono::Utc)),
        destination: body
            ...
            .and_then(|v| v.as_str())
            .map(str::to_string),
        family_notified: body
            .get("family_notified")
            .and_then(|v| v.as_bool())
            .unwrap_or(false),
        family_reunification_completed: body
            .get("family_reunification_completed")
            .and_then(|v| v.as_bool())
            .unwrap_or(false),
        patient_tracking_updated: body
            .get("patient_tracking_updated")
            .and_then(|v| v.as_bool())
            .unwrap_or(false),
        media_release_authorized: body
            .get("media_release_authorized")
            .and_then(|v| v.as_bool())
            .unwrap_or(false),
        special_circumstances: body
            .get("special_circumstances")
            .and_then(|v| v.as_str())
            .map(str::to_string),
        created_by: body
            .get("created_by")
