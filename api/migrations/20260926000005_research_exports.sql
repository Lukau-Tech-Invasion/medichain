-- =============================================================================
-- Research / secondary-use export runs (WP7.4)
-- =============================================================================
-- One row per proposed export: its stated purpose, the governance decision
-- that gates it (governance_decisions, multi-approver), and, once run, how
-- many consenting patients were included and withheld and a checksum of what
-- was released. Record shape matches the other JSON-record domains
-- (id / owner_id / data); the governance decision carries the enforced state.
--
-- No backfill: no export has ever run.
-- =============================================================================

CREATE TABLE IF NOT EXISTS research_export_runs (
    id         TEXT PRIMARY KEY,
    -- The administrator who proposed the export.
...
CREATE INDEX IF NOT EXISTS idx_research_export_runs_created
    ON research_export_runs (created_at DESC);

-- =============================================================================
-- access_logs.action: the four research-export acts. Restated in full.
-- =============================================================================
