-- =============================================================================
-- access_logs.action: pharmacy decisions and AMA signatures
-- =============================================================================
-- Two workflows that had a button and no endpoint now write audit rows, and
-- their actions need to exist in the CHECK before the first one is attempted.
-- On PostgreSQL an absent value rejects the insert after the record itself has
-- been written, and audit writes here fail closed -- so a missing CHECK value
-- is a refused clinical operation, not a lost log line.
--
